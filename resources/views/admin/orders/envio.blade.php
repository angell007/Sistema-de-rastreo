...
<body style="background-color:white">
    ...
    <table width="100%">
        <tr>
            ...
            <td style="margin: 1em .1em .1em 2em; font-weight:bold; font-size:20px; text-align: center; color:#f44336;">${{$order->valor_total}}</td>
        </tr>
    ...
    <table width="100%" style=" margin: 2em .1em .1em 0em;">
        <tr>
            <td>
                <h3 style="text-align:left;">x</h3>
                <p style="text-align: justify;">___________________________________</p>
                <p style="text-align: justify;">Recibo a conformidad</p>
                <p style="text-align: justify;">Propietario o encargado</p>
            </td>

            <td>
                <h3 style="text-align:left;">x</h3>
                <p style="text-align: justify;">___________________________________</p>
                <p style="text-align: justify;">Quien entrega</p>
                <p style="text-align: justify;">Personal autorizado</p>
            </td>
        </tr>

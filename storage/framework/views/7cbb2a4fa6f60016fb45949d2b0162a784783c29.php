    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">
            ...
            <div class="card-body">
                ...
                <form id="formClausulaRegister" method="POST" action="<?php echo e(route('clausulas.store')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\SRastreo\resources\views/admin/clausulas/partials/formRegister.blade.php ENDPATH**/ ?>
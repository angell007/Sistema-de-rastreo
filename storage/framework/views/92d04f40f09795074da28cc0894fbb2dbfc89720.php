    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
            <div class="card  bg-transparent">
                <div class="card-header"><?php echo e(__('Ingreso')); ?></div>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SRastreo\resources\views/auth/login.blade.php ENDPATH**/ ?>
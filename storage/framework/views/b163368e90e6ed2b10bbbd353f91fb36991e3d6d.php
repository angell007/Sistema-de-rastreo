    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">
            ...
            <div class="card-body">
                ...
                <form id="formClienteRegister" method="POST" action="<?php echo e(route('clientes.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <input type="submit" class="btn btn-outline-info  btn-sm" id="btnSaveCliente" value="Enviar">
...
<?php /**PATH C:\laragon\www\SRastreo\resources\views/admin/clientes/partials/formRegister.blade.php ENDPATH**/ ?>
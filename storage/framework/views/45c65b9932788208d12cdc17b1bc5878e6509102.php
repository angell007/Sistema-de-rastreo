    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">
            ...
            <div class="card-body">
                ...
                <form id="formAccionUpdate" method="" action="<?php echo e(route('acciones.update')); ?>">
                    <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\laragon\www\SRastreo\resources\views/admin/acciones/partials/formUpdate.blade.php ENDPATH**/ ?>
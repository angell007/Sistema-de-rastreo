    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">
            ...
            <div class="card-body">
                ...
                <form id="formAccionRegister" method="POST" action="<?php echo e(route('acciones.store')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\SRastreo\resources\views/admin/acciones/partials/formRegister.blade.php ENDPATH**/ ?>